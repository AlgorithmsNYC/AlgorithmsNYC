...
namespace prob3
{
    class Program
    {
        ...
        // Recursive solution with a hashtable cache to speed things up.
        ...
        static void Main(string[] args)
        {
            ...
            while (true) if (cmdInt = Convert.ToInt64(Console.ReadLine()) > 0) Console.WriteLine("{0}", GetPatternCount(cmdInt));
                else return;
        }
    }
}
